...
### 2.4.3. [[Vector Database|벡터 데이터베이스]]

### 2.4.4. [[Pinecone|파인콘]]

### 2.4.5. 오픈소스 대안
- [[Pinecone|파인콘]]외의 오픈소스 대안이 많음
- [[Pgvector]]
- [[Weaviate]]
- [[ANNOY]]

### 2.4.6. 검색 결과 재순위화
- [[Vector Database|벡터 데이터베이스]]로부터 유사도 비교(e.g. [[코사인 유사도]])를 사용하여 주어진 쿼리에 대한 잠재적 결과 검색 이후
	- 사용자에게 가장 관련된 결과 제시하도록
	- **순위**를 다시 지정하는 것이 유용함
- 결과를 **재순위화**하는 한가지 방법은
