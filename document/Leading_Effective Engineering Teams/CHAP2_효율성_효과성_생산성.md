...
- 개인적인 수준의 생산성 지표 측정을 위해 팀에서는 [[SMART 목표]]를 사용할 수 있음

### 목표-질문-지표([[GQM]])
### 목표와 핵심 결과([[OKR]])

#### '최선을 다하자'는 목표
- [[GQM]], [[OKR]], [[SMART 목표]]는 목표 설정 원칙에 근거함
- American Psychologist에 게시된 연구에 따르면
	- 계속해서 구체적이고 어려운 목표를 정하는 것이
	- 그저 최선을 다하라고 독려하는 것보다 더 높은 성과로 이어짐
- 단순히 '최선을 다하자'는 목표는 외부적인 기준이 없기에
	- 개인적이며 특이한 형태로 정의되기 마련이고
	- 이는 어디까지 성과로서 수용할 수 있는지에 대한 해석의 폭을 매우 넓힘
- 반면에, 목표의 명확성은 달성해야할 목표가 무엇인지에 대한 모호함을 줄임으로써
	- 성과가 무엇인지에 대한 다양한 해석의 폭을 줄임
- 이렇게 생산성 지표를 다른 시점에서 바라봄으로써
	- 팀은 결과물 기반 목표 -> 성과 기반 목표로 설정 가능
- 이는 팀이 올바른 일을 수행하고, 조직을 위해 가치를 창출하게 함으로써
	- 효과적인 효율성을 달성함

## 2.3.4. 효과성과 효율성 사이의 균형
- 결과물을 만들어내는 것과 성과에 우선순위를 두는 것 사이에서 적절한 균형을 찾는 일은 도전적인 일
	- 두 목표가 상호 베타적일 필요는 없음
- 따라서 이 이상적인 균형점을 찾기 위한 세 가지 핵심 요인 정의

### 전략
- 효과성은 조직의 목표를 달성하기 위해 적절한 사항들을 개선함으로써 달성
- 개선을 위한 첫번째 단계는 올바른 것들을 파악하고,
	- 그에 상응하는 목표를 도출하여
	- 이 목표를 달성하기 위한 전략을 수립하는 것

### 지표
- 목표를 정의하고 전략을 수립하였다면 계획의 성공을 어떻게 측정할 것인지 결정
- 측정 방법을 결정하는 과정에서 효율성이 효과성을 촉진하는 부분을 확인할 수 있음

### 결단과 행동
- 무엇을 할 것인지, 어떻게 그 목표 달성 과정을 파악할지 결단을 내렸다면
	- 다음 과제는 그 계획을 끝까지 실행하고 완수하는 것
- 조직의 목표와 그 목표를 달성하기 위한 개개인의 역할을
	- 구성원 모두가 파악할 수 있도록 의사소통 계획을 세우기도 해야 함


데이터 기반 접근 방식을 사용하여 성과 지표를 모니터링 하고,
- 효과성과 효율성 사이의 균형을 잡기 위한 전략을 실행함으로써
- 소프트웨어 팀은 효과성과 효율성 두 가지 사이에서 균형을 잡을 수 있음
- 이를 통해 팀을 효율적으로 운영하면서도 사용자의 요구사항을 충족하는 고품질의 코드와 서비스 제공 가능
- 넷플릭스는 이러한 접근 방법을 훌륭하게 실천하고 있음

넷플릭스는 언제나 사용자의 비디오 시청 경험을 개선하기 위해 노력하고 있음
- 넷플릭스의 목표는 모든 회원이 모든 기기에서 언제라도 고품질의 비디오를 볼 수 있게 하는 것
- 또한 모든 회원이 모든 기기에서 언제라도 고품질의 비디오를 볼 수 있게 하는 것
- 또한, 회원이 늘어남에 따라 효율적으로 확장할 수 있는 시스템을 구축하고자 함
- 그래서 넷플릭스는 이러한 목표를 달성하기 위해
	- 자신들이 보유한 방대한 스트리밍 데이터를 활용
- 또한 자신들의 데이터를 기반으로, 비디오 전송 최적화에 도움이 될 모델, 알고리즘, 분석, 실험을 설계하는 전략을 세움
- 넷플릭스에서는 이 모델들의 성공 여부를 측정하기 위해
	- 비디오 로딩 시간, 전송된 비디오의 시각적 품질, 비트 전송속도(bitrate), 비디오 중단 빈도와 같은 지표 사용
- 이러한 지표들은 사용자가 느끼는 경험의 수준과 서비스의 효과성에 직접적으로 연관되어 있음
- 이에 넷플릭스는 회원이 늘어남에 따라 이러한 지표를 지속 개선함으로써,
	- 자신들이 정한 목표 달성을 위한 행동을 보여줌

## 2.3.5. 일상에서 효과적으로 효율성을 달성하는 매일매일의 팁
- 목표 설정 프레임워크와 지표의 활용 -> 팀이 효과적으로 효율성을 달성하는데 아주 중요
- 일상속에서 리더와 팀이 올바른 방향으로 나아가는데 도움이 될만한 팁 소개

### 효과성에 우선순위를 두기
- 효율성과 생산성도 중요하긴 하지만 효과성에 방해가 되어서는 안 됨
- 일을 빠르게 하거나 효율적으로 하는 것보다, 언제라도 올바른 일을 하는 것을 우선순위에 두는 습관

### 성과에 집중하기
- 결과물이나 산출물에 근거하여 생산성을 측정하기 보다 성과와 비즈니스 가치에 집중
- 팀 구성원 모두가 추구하는 목표 및 그 목표를 이루기 위해 팀원 각자의 업무가 목표에 어떤 영향을 끼치는지 모든 팀원이 알고 있어야 함

### 지표 활용하기
- 올바른 것을 측정할 수 있다면 효율성, 효과성, 생산성 사이에 균형을 잡는 데 도움이 될 수 있음
- 단순하게 완료한 업무의 작업량만을 측정하기보다는
	- 업무의 형태와 비즈니스 가치를 측정할 수 있는 정량적인 방법 활용하기

### 협업 장려하기
- 협업은 팀원들이 지식, 기술, 아이디어를 나누는 기회
	- 이를 바탕으로 협업은 효율성, 효과성 향상 가능
- 팀원들끼리 업무를 함께 처리하고 피드백을 나눌 기회를 만들어 팀워크를 강화할 것
- 다양한 상황에서 효율성과 효과성에 도움이 되는 협업 도구를 사용하는 것도 좋음
	- 프로젝트 관리: Asana, Trello, Jira
	- 의사소통: Slack, Microsfot Teams, Zoom
	- 코드 협업 및 코드 리뷰 관리를 위한 Github, Bitbujcket, GitLab

### 팀원에게 권한 부여하기
- 팀원이 의사결정을 내리고 자신의 업무에 주인의식을 갖도록 권한을 부여하면
	- 관료주의의 부작용을 줄이고 업무 흐름 최적화 가능
	- 효율성, 생산성 향상 가능
- 팀원들은 권한을 가졌다고 느낄 대 더 적극적으로 일하고 효율적으로 업무를 처리하는 경향 존재
- 이 주제에 대해서는 다음 장에서 더 자세히 다룰 것

### 끊임없인 발전
- 언제 어느 때라도 효율성, 효과성, 생산성을 개선할 기회를 찾아야 함
	- 정기적으로 업무 흐름, 도구, 프로세스를 검토하고 팀의 성과를 극대화하기 위해 필요한 조치를 취할 것
- 팀원들에게 권한을 부여하는 것은 팀 내의 심리적 안전감을 조성하는데 큰 도움
- 마찬가지로 적절한 지표 활용을 통해 목표를 향한 체계와 명확성 확립 가능

# 2.4. 결론
효과적인 소프트웨어 엔지니어링팀을 만들기 위한 중요한 요인들인
- 적절한 팀의 크기, 다양성, 의사소통에 기반한 협력과 신뢰를 촉진하는 사고방식을 살펴봄
- 그리고 이러한 요인들의 중요성에 대해 더 깊은 탐구
- 이와 같은 요인들이 소프트웨어 엔지니어링 팀의 성공을 평가하는 중요한 지표인
	- 효율성, 효과성, 생산성의 측정에 미치는 영향도 살펴봄
- 이러한 요소들 사이에서 전략적으로 균형을 잡을 수 있다면
	- 여러분의 팀이 조직과 고객의 가치를 극대화하는 데 도움이 될 수 있음

팀 리더로서, 이 용어들 간의 미묘한 차이를 이해하는 것뿐만 아니라
- 팀이 올바른 일에 집중하고, 올바른 자원을 적절히 사용하고, 가치 있는 성과를 창출할 수 있도록
- 효율성, 효과성, 생산성 사이의 균형을 신중하게 조절해야 함

이렇게 균형을 맞추기 위해서 명확한 전략 및 달성하고자 하는 목표에 맞게 잘 정의된 지표가 필요
- 이러한 전략과 지표를 적절히 활용하고 실천해야 함
- 단순한 결과물보다 성과를 우선으로 한다면 여러분의 팀은 제품의 품질을 실질적으로 향상시킬 수 있음
- 코드 상태, 팀 정원, 협업 기회에 초점을 맞춘 선제적인 위험 완화 방안을 장려함으로써
	- 앞에서 언급한 전략과 실천법에 더욱 힘을 실어줄 수 있음

이것으로 효과성, 효율성, 생산성에 대한 논의 마무리
- 다음 장에서는 효과적인 소프트웨어 엔지니어링 팀을 위한 3E 모델을 소개
- 이 모델은 활성화, 권한과 자율성 부여, 확장으로 이루어진 모델
	- 성장하는 팀과 조직의 효과성을 향상시키는데 도움이 됨

## 확인 문제
효율성과 효과성의 주된 차이는?
- 효율성은 일을 올바르게 하는 것
- 효과성은 원하는 성과를 달성하는 것
- 이상적으로, 올바른 일을 올바르게 수행해야 함

효과성 측정을 위한 핵심 요소
- 상황에 따른 효과성 정의
- 효과성 정의에 맞는 지표 파악
- 효과성 측정시 단기적인 결과물, 수익이 아닌 장/단기적 성과 모두 고려 필요
- 진행 상황 추적, 개선할 부분을 찾기 위한 데이터 수집 및 분석

OKR을 설정하는 목표
- 명확하고, 측정 가능한 목표를 설정하고 이를 달성하기 위한 진행 상황을 추적하기 위함

효율성을 측정하는 데 중요하게 고려해야 하는 측면
- 프로세스에서 병목 현상과 낭비를 식별하고 제거하기

효과성과 효율성의 관계
- 효과성은 명확한 목표를 설정함으로써 프로젝트 기반 마련
- 효율성은 그 목표를 달성하기 위한 프로세스, 자원 최적화
- 상기 둘 모두 최적의 결과를 달성하기 위해 사용 함
- 효과성과 효율성은 상호 베타적이지 않음
- 효율성이 방향을 설정하고 효과성이 목표를 달성하는 경로를 최적화 함